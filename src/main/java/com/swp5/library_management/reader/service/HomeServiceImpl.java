...
import com.swp5.library_management.reader.dto.CategoryCardDTO;
import com.swp5.library_management.reader.dto.FeaturedBookDTO;
import com.swp5.library_management.reader.dto.HomeStatsDTO;
...
public class HomeServiceImpl implements HomeService {
    ...
    @Override
    public List<com.swp5.library_management.reader.dto.BookSectionDTO> getMajorsWithRandomBooks() {
        List<com.swp5.library_management.entity.Major> allMajors = majorRepository.findAll();
        List<com.swp5.library_management.reader.dto.BookSectionDTO> result = new ArrayList<>();
        ...
        for (com.swp5.library_management.entity.Major major : allMajors) {
            ...
            result.add(com.swp5.library_management.reader.dto.BookSectionDTO.builder()
    ...
    private List<com.swp5.library_management.reader.dto.FeaturedBookDTO> mapToFeaturedBookDTOs(List<com.swp5.library_management.entity.Book> books) {
        List<com.swp5.library_management.reader.dto.FeaturedBookDTO> bookDTOs = new ArrayList<>();
        for (int i = 0; i < books.size(); i++) {
            ...
            bookDTOs.add(com.swp5.library_management.reader.dto.FeaturedBookDTO.builder()
                    .bookId(book.getBookId())
                    .title(book.getTitle())
                    .authorNames(book.getAuthorNames())
                    .subjectCode(subjectCode)
