...
public interface UserRepository extends JpaRepository<User, String> {
    ...
    @org.springframework.data.jpa.repository.Query(value = "SELECT r.RoleName FROM Roles r JOIN Users u ON r.RoleID = u.RoleID WHERE u.UserID = :userId", nativeQuery = true)
